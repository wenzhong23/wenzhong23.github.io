...
<li>
<div class="pub-row">
  <div class="col-sm-9 abbr" style="position: relative;padding-right: 150px; padding-left: 10px;">
    <img src="{{ link.image }}" class="teaser img-fluid z-depth-1" style="width=100;height=40%">
            <abbr class="badge">{{ link.conference_short }}</abbr>
  </div>
  <div class="col-sm-3" style="position: relative;padding-right: 150px; padding-left: 20px;">

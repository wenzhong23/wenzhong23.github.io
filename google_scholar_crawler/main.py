...
scholarly.fill(author, sections=['basics', 'indices', 'counts', 'research'])
name = author['name']
author['updated'] = str(datetime.now())
author['research'] = {v['author_pub_id']:v for v in author['research']}
...
shieldio_data_mtl = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['research']['Uf9GqRsAAAAJ:bEWYMUwI8FkC']['num_citations']}",
}
...
shieldio_data_mnemonics = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['research']['Uf9GqRsAAAAJ:k_IJM867U9cC']['num_citations']}",
}
...
shieldio_data_aanets = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['research']['Uf9GqRsAAAAJ:u_35RYKgDlwC']['num_citations']}",
}
...
shieldio_data_e3bm = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['research']['Uf9GqRsAAAAJ:vV6vV6tmYwMC']['num_citations']}",
}
...
shieldio_data_lst = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['research']['Uf9GqRsAAAAJ:TFP_iSt0sucC']['num_citations']}",
}
